  ...
  public tabsItemsFirst: Array<ITabsItemSelectable> = [
    {
      ...
      leftIconUrlDefault: './assets/test-assets/tabs/icon__add_default.png',
      leftIconUrlHover: './assets/test-assets/tabs/icon__add_hover.png',
      leftIconUrlClick: './assets/test-assets/tabs/icon__add_click.png',
      leftIconUrlDisabled: './assets/test-assets/tabs/icon__add_disabled.png',
      rightIconUrlDefault: './assets/test-assets/tabs/icon__copy_default.png',
      rightIconUrlHover: './assets/test-assets/tabs/icon__copy_hover.png',
      rightIconUrlClick: './assets/test-assets/tabs/icon__copy_click.png',
      rightIconUrlDisabled: './assets/test-assets/tabs/icon__copy_disabled.png'
    },
    {
      id: 1,
      display: 'Контент 2',
      leftIconUrlDefault: './assets/test-assets/tabs/icon__clear.png',
      leftIconAreaWidth: 140,
      rightIconAreaWidth: 40,
      rightIconUrlDefault: './assets/test-assets/tabs/icon__delete.png'
    },
    {
      id: 2,
      display: '',
      leftIconUrlDefault: './assets/test-assets/tabs/icon__documents.png',
